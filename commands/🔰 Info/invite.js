...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    if (user) {
      ...
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/j8hXTVxwaj")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter(`${user.username} | powered by ThorOp`, "https://cdn.discordapp.com/attachments/887065559794057277/918244381864124436/ff55fa9a762773cb871c308a6715a748.jpg")
        ],
