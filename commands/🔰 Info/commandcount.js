  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    let tempmsg = await message.reply({
      embeds: [new MessageEmbed()
        .setColor(es.color)
        .setAuthor(handlemsg(client.la[ls].cmds.info.commandcount.tempmsg), "https://cdn.discordapp.com/attachments/887065559794057277/918244381864124436/ff55fa9a762773cb871c308a6715a748.jpg", "https://discord.gg/j8hXTVxwaj")
      ]
    })
    let lines = 0
    let letters = 0
