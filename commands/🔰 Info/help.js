...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    if (args[0]) {
      ...
      let button_tutorial = new MessageButton().setStyle('LINK').setEmoji("840260133686870036").setLabel("Leviosa").setURL("https://www.youtube.com/channel/UC5MiLSX3eP9qdGLn9TxmuNw")
      let menuOptions = [{
          label: "Overview",
          value: "Overview",
...
ThorOp(https://discord.gg/j8hXTVxwaj)`)
